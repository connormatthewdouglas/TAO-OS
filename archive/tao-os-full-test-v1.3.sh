...
#
# Changes from v1.2:
#   - Points to tao-os-presets-v0.7.sh (25 tweaks: +7 new research-backed additions)
#     New in v0.7: tcp_rmem/wmem ceiling, C6 disable by name, NUMA balancing off,
#     THP compaction proactiveness=0, netdev_max_backlog=5000, sched granularity, somaxconn
#
# Requirements: ollama installed, tinyllama pulled (ollama pull tinyllama)
# Usage: ./tao-os-full-test-v1.3.sh
#
